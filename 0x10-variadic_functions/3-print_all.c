 ...
 *
 * @format: a list of argument passed into the function
 *
 * Return: void
 */
...
/**
 * count_format - count valid type in format
 *
 * @format: format to be used 
 *
 * Return: count the valid types
 */
...
/**
 * print_comma - print a comma and space when valid
 *
 * @j: first num to be compared
 * @x: second num to be compare
 *
 * Return: void
 */
